...
Invariant: jp-inv-local-practitionerid
Description: "施設職員IDを記述する場合には、identifier.systemは、'urn:oid:1.2.392.100495.20.3.41.[1+施設番号10桁]'でなければならない。"
Severity: #error
Expression: "system.all(substring(0,31)!='urn:oid:1.2.392.100495.20.3.41.' or substring(31).matches('^1(0[1-9]|[1-3][0-9]|4[0-7])([0-9])([0-9]{7})$'))"
...
Severity: #error
Expression: "system.all(substring(0,31)!='urn:oid:1.2.392.100495.20.3.51.' or substring(31).matches('^1(0[1-9]|[1-3][0-9]|4[0-7])([0-9])([0-9]{7})$'))"

Invariant: jp-org-dept-identifier-local-system
Description: "ローカル診療科コードのsystemは 'http://jpfhir.jp/fhir/core/mhlw/CodeSystem/MedicationRequestDepartment/[1+施設番号10桁]'でなければならない。"
Severity: #error
