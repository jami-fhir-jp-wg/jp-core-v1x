...
Alias: $JP_Disease_MEDIS_Concept_CS = http://medis.or.jp/CodeSystem/master-disease-exCode // MEDIS病名交換用コード
...
//医薬品処方RP番号とRP内番号
Alias: $JP_Medication_RPGroupNumber = http://jpfhir.jp/fhir/core/mhlw/IdSystem/Medication-RPGroupNumber // urn:oid:1.2.392.100495.20.3.81 医薬品処方RP番号
...
Alias: $JP_IdSystem_MedicationDispenseDocumentID  = $http://jpfhir.jp/fhir/core/mhlw/IdSystem/MedicationDispenseDocumentID
