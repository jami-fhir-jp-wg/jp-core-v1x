CodeSystem: JP_DentalSurfaceBodyStructure_CS
...
* ^url = $JP_DentalSurfaceBodyStructure_CS
* ^status = #active
* ^experimental = false
* ^date = "2025-06-12"
* ^caseSensitive = true
...
* #TP-13 "切端・咬合面ＩＯ（切端I又は咬合面Ｏ）"
* #TP-14 "唇側面・頬側面Ｂ（唇側面Ｌａ、頬側面Ｂ又は口腔前庭面Ｖ）"
* #TP-15 "口蓋側面・舌側面ＰＬ（口蓋側面Ｐ又は舌側面Ｌ（Ｌｉ））"
* #TP-16 "近心面Ｍ"
* #TP-17 "遠心面Ｄ"
* #TP-18 "歯冠部"