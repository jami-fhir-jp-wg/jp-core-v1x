...
* #social-history "Social History" "社会歴観察では、患者の職業、個人（ライフスタイルなど）、社会歴、家族歴、環境歴、および患者の健康に影響を与える可能性のある健康リスク要因を定義。"
...
* #imaging "Imaging" "イメージングによって生成された観測。 範囲には、単純X線、超音波、CT、MRI、血管造影、心エコー検査、および核医学に関する観察が含まれる。"
* #laboratory "Laboratory" "検査室によって生成された観察結果。 検査結果は通常、化学、血液学、血清学、組織学、細胞学、解剖病理学 (デジタル病理学を含む)、微生物学、および/またはウイルス学などの分野で分析サービスを提供する検査室によって生成される。 これらの観察結果は、患者から採取され、検査室に提出された検体の分析に基づいている。"
* #procedure "Procedure" "他の手順によって生成された観察結果。このカテゴリーには介入および、検査および画像診断を除く非介入の手順から得られた観察結果が含まれる（例：心臓カテーテル検査、内視鏡検査、電気診断など）。 この観察結果は通常、手順中に得られた個々の観察結果について、より詳細な情報を提供するために臨床医によって生成される。 例としては、大腸内視鏡検査中に観察されたポリープの大きさを消化器専門医が報告する場合などが挙げられる。"
