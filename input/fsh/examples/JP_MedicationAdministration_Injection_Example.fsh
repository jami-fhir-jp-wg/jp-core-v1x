...
* extension[=].valueReference = Reference(Practitioner/jp-practionner-example-male-1) "大阪 一郎"
...
* performer.actor = Reference(Practitioner/jp-practionner-example-male-1) "愛知 太郎"
...
* performer.function = http://terminology.hl7.org/CodeSystem/med-admin-perform-function#performer "Performer"
* performer.actor = Reference(Practitioner/jp-practionner-example-female-1) "福岡 花子"
