Instance: jp-observation-dentaloral-missingtoothcondition-example-4
InstanceOf: JP_Observation_DentalOral_MissingToothCondition
Title: "JP Core Observation DentalOral Missing Tooth Condition Example 口腔診査結果４（欠損歯の状態）"
Description: "口腔診査結果４（欠損歯の状態）"
Usage: #example
* identifier[0].value = "20221001-0004"
* status = #final
...
* category[third] = $JP_ObservationDentalCategory_CS#DO-1-03 "MissingToothCondition"
