...
* bodySite.extension[bodyStructure][+] = $JP_DentalBodyStructure_CS#TP-13-01 "切端・咬合面ＩＯ（切端I又は咬合面Ｏ）"
* bodySite.extension[bodyStructure][+] = $JP_DentalBodyStructure_CS#TP-15-01 "口蓋側面・舌側面ＰＬ（口蓋側面Ｐ又は舌側面Ｌ（Ｌｉ））"
* bodySite.extension[bodyStructure][+] = $JP_DentalBodyStructure_CS#TP-16-01 "近心面Ｍ"
* bodySite.extension[bodyStructure][+] = $JP_DentalBodyStructure_CS#TP-17-01 "遠心面Ｄ"
* bodySite.extension[bodyStructure][+] = $JP_DentalBodyStructure_CS#TP-18-01 "歯冠部"
* component[+].code[primary] = $JP_DentalPresentTeethObservation_CS#TP-11-22 "部分修復（単純・複雑の情報なし）（金属インレー・金色）（Ｉｎ）"
