...
* extension[bodyStructure][+].valueCodeableConcept = $JP_DentalSurfaceBodyStructure_CS#TP-13-01 "切端・咬合面ＩＯ（切端I又は咬合面Ｏ）"
* extension[bodyStructure][+].valueCodeableConcept = $JP_DentalSurfaceBodyStructure_CS#TP-15-01 "口蓋側面・舌側面ＰＬ（口蓋側面Ｐ又は舌側面Ｌ（Ｌｉ））"
* extension[bodyStructure][+].valueCodeableConcept = $JP_DentalSurfaceBodyStructure_CS#TP-16-01 "近心面Ｍ"
* extension[bodyStructure][+].valueCodeableConcept = $JP_DentalSurfaceBodyStructure_CS#TP-17-01 "遠心面Ｄ"
