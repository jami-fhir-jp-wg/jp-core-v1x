...
Usage: #example
* category[simpleObservation] = $JP_SimpleObservationCategory_CS#vital-signs "Vital Signs"
* category[vitalSignCategory] = $JP_ObservationVitalSignsCategory_CS#vital-signs  "Vital Signs"
* subject = Reference(Patient/jp-patient-example-1)
* code.coding[0] = http://abc-hospital.local/fhir/Observation/localcode#abc-local-456 "呼吸数"
* code.coding[+] = $US_Loinc_CS#9279-1 "Respiratory rate"
