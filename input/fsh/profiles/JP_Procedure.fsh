...
* partOf only Reference(JP_Procedure or Observation or JP_MedicationAdministration)
...
* reasonReference only Reference(JP_Condition or Observation or JP_Procedure or JP_DiagnosticReport_Common or DocumentReference)
