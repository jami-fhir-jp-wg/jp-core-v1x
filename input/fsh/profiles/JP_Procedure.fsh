...
* partOf ^definition = "A larger event of which this particular procedure is a component or step.【JP-Core仕様】https://www.hl7.org/fhir/procedure.htmlを参照"
...
* focalDevice.action ^definition = "Procedure中にデバイスに起こった変化の種類。【JP-Core仕様】https://www.hl7.org/fhir/procedure.htmlを参照"
* focalDevice.manipulated ^definition = "Procedure中に操作（変更）されたデバイス。【JP-Core仕様】https://www.hl7.org/fhir/procedure.htmlを参照"
