...
* bodySite.extension[bodyStructure].extension[includedStructure].extension[structure].valueCodeableConcept from JP_DentalBodySite_VS (required)
* insert SetDefinition(bodySite.extension[bodyStructure].extension[includedStructure].extension[structure], 【JP Core仕様】複数の『歯』を繰り返し指定)

* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].value[x].coding ^slicing.discriminator.type = #value
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].value[x].coding ^slicing.discriminator.path = "system"
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].value[x].coding ^slicing.rules = #open
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].value[x].coding contains
  root 0..* and
  surface 0..*
* insert SetDefinition(bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier], 【JP Core仕様】特定の歯の歯根と、歯面の２項目を指定)

* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].valueCodeableConcept.coding[root] from $JP_DentalRootBodyStructure_VS (required)
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].valueCodeableConcept.coding[root].system = $JP_DentalRootBodyStructure_CS (exactly)
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].valueCodeableConcept.coding[root] ^short = "特定の歯の『歯根』を指定"
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].valueCodeableConcept.coding[root] ^definition = "特定の歯の『歯根』を指定"

* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].valueCodeableConcept.coding[surface] from $JP_DentalSurfaceBodyStructure_VS (required)
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].valueCodeableConcept.coding[surface].system = $JP_DentalSurfaceBodyStructure_CS (exactly)
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].valueCodeableConcept.coding[surface] ^short = "特定の歯の『歯面』を指定"
* bodySite.extension[bodyStructure].extension[includedStructure].extension[qualifier].valueCodeableConcept.coding[surface] ^definition = "特定の歯の『歯面』を指定"
