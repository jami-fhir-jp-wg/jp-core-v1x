...
* extension contains
    $encounter-associatedEncounter named associatedEncounter ..*
...
* class ^short = "Classification of patient encounter / 患者とのEncounterの分類"
...
* classHistory ^short = "List of past encounter classes / 過去のEncounter classのリスト"
...
* type ^short = "Specific type of encounter / Encounterの具体的なタイプ"
...
* serviceProvider ^short = "The organization (facility) responsible for this encounter / このEncounterに責任を持つ組織（施設）"
...
* partOf ^short = "Another Encounter this encounter is part of / このEncounterが属するもう一つのEncounter"
