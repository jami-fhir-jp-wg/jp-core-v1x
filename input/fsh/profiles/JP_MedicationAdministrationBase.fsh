...
* dosage.method ^comment = "ターミノロジーは投与する経路あるいは剤型をあらかじめ指定するために用いられる。"
...
* dosage.method.text ^requirements = "ターミノロジー由来のコードは必ずしも人間が使う言葉の全てのニュアンスを含めた正確な意味を捉えているわけではなく、適切なコードが見つからない場合もある。そのような場合でもtextエレメントは元々の意味のすべてを捉えるために使うことができる。"
...
* ^url = $JP_MedicationAdministration_Dosage_DosageComment
* ^date = "2022-03-16"
...
* ^url = $JP_MedicationAdministration_Dosage_LineComment
* ^date = "2022-03-16"
* ^context.type = #element
* ^context.expression = "MedicationAdministration.dosage"
* . ^short = "ラインコメント"
...
* ^url = $JP_MedicationAdministration_DosageMethod_MethodComment
* ^date = "2022-03-16"
* ^context.type = #element
...
* ^url = $JP_MedicationAdministration_DosageRate_RateComment
* ^date = "2022-03-16"
* ^context.type = #element
...
* ^url = $JP_MedicationAdministration_DosageRoute_RouteComment
* ^date = "2022-03-16"
* ^context.type = #element
...
* ^url = $JP_MedicationAdministration_DosageSite_SiteComment
* ^date = "2022-03-16"
* ^context.type = #element
