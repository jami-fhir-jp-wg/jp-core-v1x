...
* category[third] from JP_ObservationElectrocardiogramExtraCategory_VS 
* category[third] ^comment = "心電図検査について、負荷試験などの条件をつけた分類"
* category[third].system = $JP_ObservationElectrocardiogramExtraCategory_CS
...
* component.code from $Loinc_CS (preferred)
