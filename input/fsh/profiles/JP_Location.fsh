...
* hoursOfOperation ^short = "What days/times during a week is this location usually open / この場所は通常、1週間のうち何日/時間帯に営業しています。"
...
* hoursOfOperation.allDay ^short = "The Location is open all day / その場所は終日営業しています"
