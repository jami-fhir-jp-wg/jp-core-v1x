...
* category contains
    medicationFeeScoreCategory ..1 and
    medicationCategory ..* and
    other ..*
...
* category[medicationCategory] ^comment = "薬剤が投与あるいはその他の用途で利用されると想定される場面についての区分である。"
* category[medicationCategory] ^binding.description = "MedicationRequest Resourceの区分を示すコード化された概念。たとえば、どこで服薬あるいは投与されるか、治療の種別はどうかについて。"
* category[other] ^short = "プロファイルを区別するためのカテゴリ。medication固定"
...
* category ^slicing.rules = #open
* category contains 
    medicationFeeScoreCategory 1..1 and
    injectionCategory ..* and
    other ..*
...
* category[injectionCategory] ^comment = "薬剤が投与あるいはその他の用途で利用されると想定される場面についての区分である。"
* category[injectionCategory] ^binding.description = "MedicationRequest Resourceの区分を示すコード化された概念。たとえば、どこで服薬あるいは投与されるか、治療の種別はどうかについて。"
* category[other] ^short = "その他分類"
