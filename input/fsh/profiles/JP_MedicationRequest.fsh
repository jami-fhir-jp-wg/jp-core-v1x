...
* dosageInstruction.doseAndRate.rateRatio ^short = "単位時間内での薬剤量"
* dosageInstruction.doseAndRate.rateRatio ^definition = "単位時間内での薬剤量。JP Coreでは1日投与量を表す。"
* dosageInstruction.doseAndRate.rateRatio ^comment = "【JP Core仕様】日本ではまだ一般的に利用されている一日量での処方のためにrateRatioを用いる。"
...
* dosageInstruction.doseAndRate.rateRatio.numerator ^short = "1日投与量"
* dosageInstruction.doseAndRate.rateRatio.numerator ^definition = "1日投与量"
