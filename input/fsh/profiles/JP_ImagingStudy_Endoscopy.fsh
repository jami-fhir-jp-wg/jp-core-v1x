...
* modality ^short = "DICOM画像検査で使用された撮影装置（モダリティ）。"
...
* procedureReference ^short = "実施された処置に関する情報。"
...
* reasonReference ^short = "DICOM画像検査の実施理由に関する情報。"
...
* description ^short = "DICOM画像検査に関する記述。"
...
* series.uid ^short = "シリーズを一意に識別するためのUID。"
...
* series.modality MS
* series.modality ^short = "このシリーズが取得された撮影装置（モダリティ）。"
...
* series.instance.uid ^short = "インスタンス（画像）のユニークID。"
...
* series.instance.sopClass ^short = "SOPクラスUID。"
...
* series.instance.number ^short = "SOP Instance UIDとは別に、ユーザー（または装置）が自由に決められるインスタンス（画像）ごとの番号。"
...
* series.instance.title ^short = "画像に関する説明。"
