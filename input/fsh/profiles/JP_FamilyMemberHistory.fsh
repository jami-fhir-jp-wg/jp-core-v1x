...
* ^status = #draft
* ^date = "2022-09-16"
* . ^short = "Information about patient's relatives, relevant for patient. 患者の家族に関する情報のうち、患者の診療に関連する情報（家族歴）"
...
* name ^short = "The family member described. この家族の呼び名。"
...
* relationship ^short = "Relationship to the subject. 患者とこの家族との関係（父、母、兄弟など）"
...
* born[x] ^short = "(approximate) date of birth. この家族の生年月日（おおよそ）"
* born[x] ^definition = "The actual or approximate date of birth of the relative.\r\n\r\n家族の実際もしくはおおよその生年月日。"
* age[x] ^short = "(approximate) age. この家族の年齢（おおよそ）"
...
* deceased[x] ^short = "Dead? How old/when? この家族が亡くなっているか、そうであれば何歳でいつ亡くなったか。"
...
* reasonCode ^short = "Why was family member history performed? なぜ家族歴が聴取されたか（きっかけとなった患者の疾患）"
...
* reasonReference ^short = "Why was family member history performed? （なぜ家族歴が聴取されたか（きっかけとなったFHIRリソース）"
...
* condition ^short = "Condition that the related person had. この家族が有する疾患歴。"
