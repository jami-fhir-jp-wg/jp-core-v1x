...
// ==============================
//-------------------------------
// JP_FamilyMemberHistory_GenderedSiblingOrder
//-------------------------------
...
* extension contains
    genderedSiblingOrder 0..1 and
    genderedSiblingOrderDisplay 0..1
* extension[genderedSiblingOrder] ^short = "性別同胞内出生順（整数）"
* extension[genderedSiblingOrder] ^definition = "同胞内での出生順を性別別に表現した数値。"
* extension[genderedSiblingOrder].value[x] only integer
* extension[genderedSiblingOrder].value[x] ^minValueInteger = 1
* extension[genderedSiblingOrderDisplay] ^short = "性別同胞内出生順ラベル"
* extension[genderedSiblingOrderDisplay] ^definition = "同胞内での出生順を性別別に表現したラベル。"
* extension[genderedSiblingOrderDisplay].value[x] only CodeableConcept
* extension[genderedSiblingOrderDisplay].valueCodeableConcept from $JP_GenderedSiblingOrder_VS (preferred)
