...
* category[laboratory].coding.system = $US_Loinc_CS
* category[laboratory].coding.code = $US_Loinc_CS#LP29693-6
...
* code.coding[laboratoryCode] = $US_Loinc_CS#11502-2 "Laboratory report"
