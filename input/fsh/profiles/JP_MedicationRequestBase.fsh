...
* dosageInstruction.timing ^short = "服用タイミング"
* dosageInstruction.timing ^definition = "服用タイミングを記録する。"
...
* dosageInstruction.timing.repeat.bounds[x] ^short = "服用開始日から服用終了日までの全日数"
* dosageInstruction.timing.repeat.bounds[x] ^definition = "服用開始日から服用終了日までの全日数。実投与日数ではないことに注意する。"
