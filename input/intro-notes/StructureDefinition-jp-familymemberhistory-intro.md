...
1. 基本的な家族歴(Family Member History)
    - 「喘息」のように正確な病名の場合もあれば、「癌（部位不明）」のように、あまり正確でない場合もある。同様に、「叔母（長女）の幸子」と人物を特定できる場合もあれば、「次男」としかわからない場合もある。このように、家族全員ではなく、断片的な病歴になることが多い。
...
日常の診療では家族の個人名まで聴取されることは少なく、長女や次男などの続柄で記録される場合が多い。また、ジェノグラムを用途とした場合、社会的な背景（遺産相続など）から同胞内の出生順（長男、長女、次男、次女など）を表現する必要性が高い。そのため、「同胞内出生順」として拡張し、表現する。
