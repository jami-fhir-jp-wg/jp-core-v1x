このドキュメントは日本医療情報学会NeXEHRS課題研究会「HL7®FHIR® 日本実装検討WG」で作成した実装ガイドのVer.1.2.0のパブリックコメント募集版である。実装や利用は全て自己責任で行なうこと。 <br/>

* パブリックコメント
  * 送付先：comment＠jpfhir.jp (＠を半角に変更してください)
  * 期間：2024/12/31〜2025/2/28
...
* <a href="https://jpfhir.jp/">日本医療情報学会NeXEHRS研究会FHIR日本実装検討WG</a>
  ...
  * Diagnostics and Observations : 検査・診断SWG
